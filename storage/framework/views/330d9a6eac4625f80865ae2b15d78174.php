  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .status-pill {
      ...
      color: <?php echo e($sc['text']); ?>;
      border: 1.5px solid <?php echo e($sc['border']); ?>;
      border-radius: 99px;
      padding: 10px 20px;
      font-size: 13px;
      font-weight: 600;
  ...
  <div class="wrapper">
    ...
    <div class="card">
      ...
      <div class="hero">
        ...
        <div class="hero-sub"><?php echo e(now()->format('F j, Y \a\t g:i A')); ?></div>
      </div>
      ...
      <div class="body">
        ...
        <p class="greeting">
          Good day! Your <strong><?php echo e(class_basename($model)); ?></strong> request submitted to the barangay office
        ...
        <div class="info-card">
          ...
          <div class="info-row">
            ...
            <span class="info-val"><?php echo e(class_basename($model)); ?></span>
          </div>

          <div class="info-row">
            <span class="info-key">Reference No.</span>
            <span class="info-val mono"><?php echo e($model->getDocumentNumber()); ?></span>
          </div>

          <div class="info-row">
            <span class="info-key">Current Status</span>
            <span class="info-val" style="color: <?php echo e($sc['text']); ?>;"><?php echo e($model->status); ?></span>
          </div>

          <div class="info-row">
            <span class="info-key">Last Updated</span>
            <span class="info-val" style="font-family: 'DM Sans', sans-serif; font-size: 13px;">
              <?php echo e($model->updated_at?->format('F j, Y') ?? now()->format('F j, Y')); ?>
...
</html><?php /**PATH C:\Users\CK\Pictures\Barangay MIS\resources\views/emails/status-updated.blade.php ENDPATH**/ ?>