                                ...
                                <tr>
                                    <td style="padding:20px 24px;">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="font-size:15px;color:#0a1628;font-weight:600;padding-bottom:12px;">{{ $filename }}</td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td style="vertical-align:top;padding-bottom:12px;">
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left:12px;font-size:13px;color:#555555;line-height:1.6;vertical-align:top;">Save the attached <strong>{{ $filename }}</strong> to your device.</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
